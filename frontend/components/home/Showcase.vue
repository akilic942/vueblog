  ...
  <section class="bg-secondary pb-24 pt-12">
    <div class="container m-auto px-8 xl:px-32">
      ...
      <div class="grid grid-cols-4 gap-x-3 gap-y-8 mt-48">
        ...
        <Case class="col-span-4 md:col-span-2" :h1="'Ediya.de - Consulting a Friend Building his Business'" h2="A Growth Journey for the Two of Us" :tags="['UX Consulting and Strategy', 'User Research']" :imgCss="'bg-gradient-to-t from-[#96BF48] to-[#9cb965]'" :imgUrl="require('~/assets/images/showcase/case_ediya/thumbnail.png')" :hoverBool="true" />
