<template>
  ...
  <section class=" pb-24 pt-12">
    <div class="container m-auto px-8 xl:px-32 pt-32 md:pt-28">
      ...
      {name:'2️⃣ Contact Tracing Supervisor', text:'Secondary user in charge of the employees. Assigns daily tasks and is in direct contact with Doctors. Secondary user of the future system.'},
...
import IntroComponent from "@/components/CaseStudy/old/IntroComponent";
